...
public class NavigationDrawerFragment extends Fragment implements DrawerAdapter.ClickListener{
    ...
    public static List<Information> getData(){
        ...
        String[] titles = {"Nova Busca de Rota", "Buscas Anteriores", "Perfil", "Troféus e Missões", "Ranking", "Preferências"};
    ...
    public void itemClicked(View view, int position) {
        ...
        if (position == 1){
            Intent intent = new Intent(getActivity(), BuscasAnterioresActivity.class);
            startActivity(intent);
        }
